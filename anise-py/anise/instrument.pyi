...
class Instrument:
    ...
    def __new__(
        cls, q_to_i: typing.Any, offset: typing.Any, fov: typing.Any
    ) -> Instrument:
        """Instrument is defined by a mounting Euler Parameter, a mounting translation ("level arm"), and a field of view of the instrument.
        Notations: frame N is inertial; frame B is body; frame I is instrument."""
    ...
    def footprint(
        self,
        sc_q_n_to_b: rotation.Quaternion,
        sc_state_target: astro.Orbit,
        q_n_to_target: rotation.Quaternion,
        resolution: int,
    ) -> list[astro.Orbit]:
    ...
    def fov_margin_deg(
        self,
        sc_q_to_b: rotation.Quaternion,
        sc_state: astro.Orbit,
        target_state: astro.Orbit,
    ) -> float:
    ...
    def is_target_in_fov(
        self,
        sc_attitude_inertial_to_body: rotation.Quaternion,
        sc_state: astro.Orbit,
        target_state: astro.Orbit,
    ) -> bool:
    ...
    def transform_state(
        self, q_sc_to_b: rotation.Quaternion, sc_state: astro.Orbit
    ) -> tuple[rotation.Quaternion, astro.Orbit]:

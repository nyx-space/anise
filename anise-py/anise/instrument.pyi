...
Notations: frame N is inertial; frame B is body; frame I is instrument."""
    ...
    def footprint(self, sc_q_n_to_b: Quaternion, sc_state_target: Orbit, q_n_to_target: Quaternion, resolution: int) -> list[Orbit]:
...
expressed in the `target_frame` (Fixed)."""
    ...
    def fov_margin_deg(self, sc_q_to_b: Quaternion, sc_state: Orbit, target_state: Orbit) -> float:
...
- If the target state frame ID is not identical to the instrument's inertial state given the sc_attitude Euler Parameter."""
    ...
    def is_target_in_fov(self, sc_attitude_inertial_to_body: Quaternion, sc_state: Orbit, target_state: Orbit) -> bool:
        """Checks if a target is visible within the Field of View."""

    def transform_state(self, q_sc_to_b: Quaternion, sc_state: Orbit) -> tuple[Quaternion, Orbit]:

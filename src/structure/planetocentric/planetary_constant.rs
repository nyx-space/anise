...
use super::nutprec::NutationPrecessionAngle;
use super::{phaseangle::PhaseAngle, MAX_NUT_PREC_ANGLES};
use crate::NaifId;
...
mod planetary_constants_ut {
    ...
    fn pc_encdec_with_dec_pm_only() {
        ...
        dbg!(core::mem::size_of::<PlanetaryConstant>());
    }
    ...
    fn test_301() {
        ...
        let moon_dec = PlanetaryConstant::from_der(&buf).unwrap();
